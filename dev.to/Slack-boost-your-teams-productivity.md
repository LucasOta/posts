...
# Table of Content
1. [Don’t be afraid of creating channels](#create-channels)
2. [Prioritize information at first glance](#prioritize-information)
3. [An emoji is worth a thousand words](#emojis)
4. [We are not tailors, but please, let's use more threads](#threads)
5. [@channel vs @here ](#tags)
6. [Custom status](#custom-status)
7. [Standardize message formats](#standarize-messages)
8. [Remove previews](#remove-previews)
9. [One Single Message](#one-single-message)
10. [Avoid Direct Messages when talking about the project](#avoid-dms)
11. [Adopting these practices is a team work](#team-work)
...
E.g., a code review, a mail review, a cry for help inside a task thread, a concern about something.
 - 🟥 Red square: requires urgent attention, something must be done immediately. 
